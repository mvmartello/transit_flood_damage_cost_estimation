...
window.flooded_hvy_surf_d_lens = [];
window.flooded_light_surf_d_lens = [];
...
window.depth_surf_d_lens = [];
//Initialize station and yard flood depth array
window.depth_sta_yards = [];
//Initialize average underground flood depth array
window.depth_underground_avg = [];


//Generate a web worker for each scenario
self.webworker0 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker1 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker2 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker3 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker4 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker5 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker6 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker7 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker8 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker9 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker10 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker11 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker12 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker13 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker14 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker15 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker16 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker17 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker18 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker19 = new Worker("libraries/js/cost_estimate_worker.js");
self.webworker20 = new Worker("libraries/js/cost_estimate_worker.js");

//Wait a few seconds for all the data to load and for the plots to draw
window.run_all = function() {
    //Indicate this started
    console.log('sent instructions to workers');
    //Tell each worker to run the cost estimate for its assigned scenario
    //webworker0.postMessage([exposure_out1,0,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker1.postMessage([exposure_out1,1,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker2.postMessage([exposure_out1,2,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker3.postMessage([exposure_out1,3,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker4.postMessage([exposure_out1,4,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker5.postMessage([exposure_out1,5,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker6.postMessage([exposure_out1,6,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker7.postMessage([exposure_out1,7,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker8.postMessage([exposure_out1,8,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker9.postMessage([exposure_out1,9,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker10.postMessage([exposure_out1,10,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker11.postMessage([exposure_out1,11,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker12.postMessage([exposure_out1,12,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker13.postMessage([exposure_out1,13,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker14.postMessage([exposure_out1,14,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker15.postMessage([exposure_out1,15,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker16.postMessage([exposure_out1,16,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker17.postMessage([exposure_out1,17,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker18.postMessage([exposure_out1,18,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker19.postMessage([exposure_out1,19,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);
    //webworker20.postMessage([exposure_out1,20,10000, cost_est_dist, SOV_replace_costs, GL_surface, GL_underground, connecting, hvy_surface, hvy_underground, SL_underground, tunnel_locations, sta_lines]);

};

//When each worker is finished, tell them to report results to compiled_costs and to terminate
webworker0.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker0.terminate();
};
webworker1.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker1.terminate();
};
webworker2.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker2.terminate();
};
webworker3.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker3.terminate();
};
webworker4.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker4.terminate();
};
webworker5.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker5.terminate();
};
webworker6.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker6.terminate();
};
webworker7.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker7.terminate();
};
webworker8.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker8.terminate();
};
webworker9.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker9.terminate();
};
webworker10.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker10.terminate();
};
webworker11.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker11.terminate();
};
webworker12.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker12.terminate();
};
webworker13.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker13.terminate();
};
webworker14.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker14.terminate();
};
webworker15.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker15.terminate();
};
webworker16.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker16.terminate();
};
webworker17.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker17.terminate();
};
webworker18.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker18.terminate();
};
webworker19.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker19.terminate();
};
webworker20.onmessage = function(e) {
    compiled_costs.push(e.data[0]);    console.log(e.data[0]);    webworker20.terminate();
};
 
    ///////////////////////////////////////////////////////////////////////////////////
    //Statistical cost analysis, using flooded locations, length, and depths calculated above
			window.cost_analysis  = function(event,num_trials) {
                ...
                self.asset_variable_list = [];
                
                //Reset variable sin asset_variable_list
                asset_variable_list.forEach(function(variable){
                    self[variable] = [];
                });
                ...
                console.log('inside MC total costs');
                ...
                function MC_runs() {
                    ...
                    for (var i = 0; i< num_trials; i++) {
                        ...
                        RL_cost += cost_by_line("RL",exposure_out1[event].RL);
                        OL_cost += cost_by_line("OL",exposure_out1[event].OL);
                        BL_cost += cost_by_line("BL",exposure_out1[event].BL);
                        GL_cost += cost_by_line("GL",exposure_out1[event].GL);
                        GL_B_cost += cost_by_line("GL_B",exposure_out1[event].GL_B);
                        GL_C_cost += cost_by_line("GL_C",exposure_out1[event].GL_C);
                        GL_D_cost += cost_by_line("GL_D",exposure_out1[event].GL_D);
                        GL_E_cost += cost_by_line("GL_E",exposure_out1[event].GL_E);
                        SL_cost += cost_by_line("SL",exposure_out1[event].SL);
                        ...
                        //Get costs for all Points of Interest (POI)
                        exposure_out1[event].POI_flood.forEach(function(item) {
                            //Get the flooded depth for the POI
                            ...
                            //Check to see if the POI varaible is in the variable list
                            if (asset_variable_list.includes(item.POI) == false) {
                                //If not, add identifier string to asset variable list
                            ...
                            if(SOV_locations.includes(item.POI) == true) {
                                ...
                                if(connecting.includes(item.POI) == true) {
                                    ...
                                    //console.log(getSOVdata(item.POI)[0].Mean);
                        ...
                        //Total cost check
                        //console.log("Total cost == line costs" + total_cost + "and" + (RL_all_cost+OL_all_cost+BL_all_cost+GL_all_cost+SL_all_cost+connect_sta_cost));
                        //console.log("Total cost == line costs" + total_cost + "and" + (linear_all_cost+facilities_all_cost));
                        //console.log("Facilities cost == facility type costs" + facilities_all_cost + "and" + (underground_all_cost+at_grade_all_cost+yard_all_cost+connect_sta_cost));
                        //console.log("Linear cost == linear all costs" + linear_all_cost + "and" + (_3rd_rail_all_cost+catenary_all_cost+lighting_all_cost+power_all_cost+rail_all_cost+signal_all_cost+tunnel_struct_all_cost));
                        ...
                        if (total_cost < 0 || isNaN(total_cost) == true) {
                            ...
                            if (event == 20) {
                                ...
                                total_cost = ((GL_cost+GL_B_cost+GL_C_cost+GL_D_cost+GL_E_cost+ GL_surf_sta_cost + GL_under_sta_cost))*(0.03+jStat.beta.inv(Math.random(), 2.109062447, 5.113339739)*(0.99-0.03));
                                //total_cost = Math.max(1,(1/jStat.normal.inv(Math.random(), 3.26, 1.18)))*(GL_cost+GL_B_cost+GL_C_cost+GL_D_cost+GL_E_cost+ GL_surf_sta_cost + GL_under_sta_cost);
                            }
                            //////////////////////////////
                            //Push to storage variables
                            //Total costs
                            cost_obj.push({"total_cost":total_cost}); MC_total_cost_objs.push(cost_obj);
                    ...
                    console.log(detailed_cost_summary);
...
d3.csv("Input/Sta_Class.csv", function(data) {
    ...
    window.GL_surface = [];
    window.GL_underground = [];
    window.connecting = [];
    window.hvy_surface = [];
    window.hvy_underground = [];
    window.SL_underground = [];
...
//Import the station line type list using d3
d3.csv("Input/Sta_by_line.csv", function(data) {
    //Initialize the station type lists
    self.sta_lines = {RL:[], OL: [], BL:[], GL:[], SL:[], connecting:[]};
        
    //For each row of data in the csv file, check to see if list cell is empty. If not, add to list
    data.forEach(function(d){
        if (d.RL != ""){
            sta_lines.RL.push(d.RL);    
        }
        if (d.OL != ""){
            sta_lines.OL.push(d.OL);    
        }
        if (d.BL != ""){
            sta_lines.BL.push(d.BL);    
        }
        if (d.GL != ""){
            sta_lines.GL.push(d.GL);    
        }
        if (d.SL != ""){
            sta_lines.SL.push(d.SL);    
        }
        if (d.Connecting != ""){
            sta_lines.connecting.push(d.Connecting);    
        }
...
d3.csv("Input/SOV_replacement_costs.csv", function(data) {
    ...
    //Create the js variable
    window.SOV_replace_costs = data;
    
});

//Create SOV location list
window.SOV_locations = [];
...
window.getSOVdata = function(loc) {
    ...
    //Else, if the line of interest is the Blue Line
        ...
        for (i = 0; i < line_expo_in.length; i++) {
            ...
            if ((tunneled.x0 < 10*i) && (10*i <= tunneled.x1)) {
                ...
                //Tunnel structure
                //if (line_expo_in[i] > 0) {
                //    console.log("tunneled.x0: " + tunneled.x0);
                //    console.log("tunneled.x1: " + tunneled.x1);
                //    console.log("STA: " + 10*i + " depth:" + line_expo_in[i] + "ft");
                //    console.log(tunneled.x0 < 10*i <= tunneled.x1);
                //}
                line_struct_cost_out += (10/5280)*jStat.normal.inv(Math.random(), cost_est_dist[25].Mean, cost_est_dist[25]["Std. Dev"])*alpha_u(Math.random(),alpha_struct,line_expo_in[i]);
                //Lighting (SL SIGNAL PLACEHOLDER REPLACEMENT COSTS)
                line_light_cost_out += (20/5280)*jStat.normal.inv(Math.random(), cost_est_dist[6].Mean, cost_est_dist[6]["Std. Dev"])*alpha_u(Math.random(),alpha_light,line_expo_in[i]);
...
//Rail roads
window.alpha_RR = function(depth_in_feet) {
...
window.alpha_ECC = function(depth_in_feet) {
    //depth = [meters], thus to convert entry, multiply by 0.3048
...
//Vehicles
window.alpha_V = function(depth_in_feet) {
    //depth = [meters], thus to convert entry, multiply by 0.3048
...
window.alpha_u = function(XYZ_pctile, ALPHA_XYZ, depth) {
    //If the flood depth is less than 0.49ft, is undefined, or NaN
    if (depth < 0.49 || depth == undefined || isNaN(depth) == true) {
        //Return 0
        return 0;
    } else {
        //Consider flood depth uncertainty via normal dist. with a 90% CI = +/- 20% of the flood depth (std.dev. = 0.0304*4*depth)
        //var depth_u = depth;
        var depth_u = jStat.normal.inv(Math.random(),depth,depth*0.122);
